...
namespace ShopManagement.Infrastructure.EfCore.Migrations
{
    ...
    [Migration("20210830042906_initial")]
            ...
            modelBuilder.Entity("ShopManagement.Domain.CourseAgg.Course", b =>
                {
                    ...
                    b.OwnsMany("ShopManagement.Domain.AfterTheCourseAgg.AfterTheCourse", "AfterTheCourses", b1 =>
                        {
                            b1.Property<long>("Id")
                                .ValueGeneratedOnAdd()
                                .HasColumnType("bigint")
                            ...
                            b1.ToTable("AfterTheCourses");

                            b1.WithOwner("Courses")
                                .HasForeignKey("CourseId");

                            b1.Navigation("Courses");
                        });

                    b.OwnsMany("ShopManagement.Domain.CoursePrerequisiteAgg.CoursePrerequisite", "CoursePrerequisites", b1 =>
                        {
                            b1.Property<long>("Id")
                                .ValueGeneratedOnAdd()
                                .HasColumnType("bigint")
                            ...
                            b1.ToTable("CoursePrerequisites");
                    ...
                    b.OwnsMany("ShopManagement.Domain.CourseSuitableAgg.CourseSuitable", "CourseSuitableList", b1 =>
                        {
                            b1.Property<long>("Id")
                                .ValueGeneratedOnAdd()
                                .HasColumnType("bigint")
